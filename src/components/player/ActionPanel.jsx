...
export const ActionPanel = () => {
    ...
    return (
        <div id="action-panel" className="panel">
            ...
            <div id="btn-dash">{cp.charType === 'athlete' && <ClayButton onClick={actionDash} disabled={!hasAP(3) || !isMyTurn} color="green">💨 疾風ダッシュ (3AP)</ClayButton>}</div>
            ...
            <div id="btn-end"><ClayButton color="red" onClick={actionEndTurn} disabled={!isMyTurn || !diceRolled || isBusy}>🛑 ターン終了</ClayButton></div>
        </div>
    );
};