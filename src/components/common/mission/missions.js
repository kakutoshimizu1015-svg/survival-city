...
// ミッションのマスターデータ
// th: 目標値 (threshold)
// rw: 報酬内容 (g: グレード, nm: 名前/内容, ic: アイコン)
export const MISSIONS = {
  wins: [
    ...
    { id: "w06", th: 10, label: "10勝", desc: "本物の強者", rw: { g: "SR", nm: "サバイバーSR", ic: "🧥" } },
    ...
    { id: "w14", th: 100, label: "100勝", desc: "サバイバー王", rw: { g: "UR", nm: "キングUR", ic: "🏆" } },
  ...
  money: [
    ...
    { id: "m07", th: 5000, label: "実業家", desc: "累計5,000P", rw: { g: "R", nm: "スーツR", ic: "🤵" } },
    ...
    { id: "m15", th: 100000, label: "P神話", desc: "累計10万P", rw: { g: "UR", nm: "ウェルスUR", ic: "🏦" } },
  ...
  move: [
    ...
    { id: "v15", th: 20000, label: "移動の神", desc: "2万マス移動", rw: { g: "UR", nm: "スピードUR", ic: "🌀" } },
  ...
  npc: [
    ...
    { id: "n19", th: 100, label: "NPC100回", desc: "NPC合計100回遭遇", rw: { g: "UR", nm: "ストリートゴッドUR", ic: "👹" } },
