                ...
                {currentTab === 7 && (
                    <div className="tut-page active">
                        ...
                        <div className="tut-char-grid">
                            ...
                            <CharCard emoji="🎲" name="ギャンブラー" role="ハイリスク・ハイリターン型" passive="ゾロ目でAP2倍＋HP+10回復" action="イカサマ勝負（2AP）:1d6対決・勝者が5P奪取" strategy="ゾロ目パッシブが発動すると爆発的なAPで一気に行動可能。イカサマ勝負は期待値的にはイーブンだが、スキルとして常時使えるため、Pが少ない相手に仕掛けるとローリスク。ゾロ目が出た時にスケボーやエナドリを合わせて超大型ターンを作るのがロマン。安定感には欠けるが爆発力はNo.1。" color="#f1c40f" />
                            <CharCard emoji="🕵️" name="元探偵" role="防衛＆コントロール型" passive="自陣地に侵入した相手の手札を1枚没収" action="情報操作（3AP）:NPC1体を任意のマスへ移動" strategy="陣地を多めに確保し、張り込みパッシブで他プレイヤーのカードを奪う防衛型。人気ルート上の陣地を取ると、通過する相手から次々とカードを没収できる。情報操作はヤクザや警察を他プレイヤーのマスに送り込む妨害技。守りを固めつつ、NPCで遠隔から嫌がらせする陰湿プレイが真骨頂。" color="#95a5a6" />
                        </div>
                    </div>
                )}
            </div>
