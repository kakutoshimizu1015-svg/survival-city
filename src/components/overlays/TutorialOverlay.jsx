                ...
                {currentTab === 7 && (
                    <div className="tut-page active">
                        ...
                        <div className="tut-char-grid">
                            ...
                            <CharCard emoji="🎸" name="ストリートミュージシャン" role="支援＆制圧型" passive="同マス/隣接+3P＆自陣地コスト-2P＆自陣地防衛" action="アンコール（3AP）:周囲2マス引寄＆人数×2P＆次移動AP+1" strategy="自身のいるマスを「陣地コスト-2P」で買い集め、パッシブと合わせて強固なエリアを形成する「エリアコントロール型」。アンコールで相手を引き寄せて稼ぎつつ、移動ペナルティを与えて足止めできるのが強力。引き寄せた相手からの攻撃はカリスマで無効化できるため、安全に搾取できる。" color="#9b59b6" />
                            <CharCard emoji="🩺" name="闇医者" role="持久＆金策型" passive="ターン開始時HP+8（HP50以下なら+16）" action="毒入り治療（2AP）:相手HP+30→5P徴収＆3R毒状態" strategy="自己回復が強化され、HP50以下なら毎ターン16回復するため非常にしぶとい。アクションの「毒入り治療」は、相手を30回復させる代わりに5Pを奪い、さらに毎ターン8ダメージの毒（合計24ダメ）を与える極悪スキル。実質的に相手のHPを削りながら金を奪えるため、積極的にばら撒こう。" color="#1abc9c" />
                            <CharCard emoji="🎲" name="ギャンブラー" role="ハイリスク・ハイリターン型" passive="ゾロ目AP倍+HP10回復＆25%で3ダイス発動" action="ドロー勝負（3AP）:カード1枚ドロー（1T3回まで）" strategy="アドレナリンによる爆発的な行動力に加え、「ドロー勝負」で1ターンに最大3枚もカードを引ける手札特化型。APを大量に稼ぎ、ドローで攻撃カードや妨害カードを引き込み、カードの暴力で盤面を制圧するスタイル。手札上限オーバーに注意しつつ、ガンガンカードを使っていこう。" color="#f1c40f" />
                            <CharCard emoji="🕵️" name="元探偵" role="防衛＆コントロール型" passive="自陣地に相手が完全に止まると50%で手札1枚没収" action="情報操作(3AP) / 罠の設置(2AP)" strategy="「罠の設置」でマップに自分だけが見える罠（警察/落とし穴/情報撹乱）を仕掛け、相手をコントロールする。画面の「長押しスキャン」でこっそり罠の位置を確認可能。パッシブの没収確率も50%に上がり、陣地に止まった相手からカードを容赦なく奪う。情報操作と罠を組み合わせて相手を絡め取ろう。" color="#95a5a6" />
                        </div>
                    </div>
                )}
            </div>
