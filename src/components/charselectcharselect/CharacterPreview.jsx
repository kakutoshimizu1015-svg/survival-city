  ...
  if (!character) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: 14, color: '#8d6e63', fontFamily: "'M PLUS Rounded 1c', sans-serif" }}>
          キャラクターを選んでください
        </div>
      </div>
    );
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{
            fontSize: 22, fontWeight: 900, color: '#fdf5e6',
            fontFamily: "'M PLUS Rounded 1c', 'Noto Sans JP', sans-serif",
          }}>
            {character.name}
          </div>
          <div style={{
            fontSize: 11, color: '#b0a090', marginTop: 3, lineHeight: 1.5,
            fontStyle: 'italic',
          }}>
            「{character.tagline}」
          </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, fontWeight: 700, color: '#fdf5e6', marginBottom: 3 }}>
          {character.passive?.name}
        </div>
        <div style={{ fontSize: 11, color: '#b0a090', lineHeight: 1.6 }}>
          {character.passive?.desc}
        </div>
      </div>
