...
export const TILE_COLORS = {
    "normal":     { bg: "#4d5e3a", top: "#6b7f52", hi: "#8a9e6a" },
    "can":        { bg: "#6a7b2e", top: "#8a9b3e", hi: "#a0b050" },
    "trash":      { bg: "#7a5a1e", top: "#9a7a2e", hi: "#b89840" },
    "shop":       { bg: "#3a6a7a", top: "#4a8a9a", hi: "#5aa0b0" },
    "exchange":   { bg: "#5a3a7a", top: "#7a4a9a", hi: "#9a60b0" },
    "job":        { bg: "#7a4a2e", top: "#9a5a3e", hi: "#b07050" },
    "koban":      { bg: "#7a3a4a", top: "#9a4a5a", hi: "#b06070" },
    "event":      { bg: "#7a2e7a", top: "#9a3e9a", hi: "#b050b0" },
    "shelter":    { bg: "#2e6a3a", top: "#3e8a4a", hi: "#50b060" },
    "manhole":    { bg: "#2a2a2a", top: "#3a3a3a", hi: "#505050" },
    "center":     { bg: "#8a2a2a", top: "#aa3a3a", hi: "#c05050" },
};

// 座標・Z軸（奥行き）を付与するヘルパー関数
