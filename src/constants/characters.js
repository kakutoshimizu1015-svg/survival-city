...
export const CHARACTERS = [
    ...
    },
    {
        ...
        name: 'ストリートミュージシャン',
        emoji: '🎸',
        infoDesc: '【投げ銭】他者が同マスor隣接で銀行+3P / 【路上ライブ】4AP:周囲2マス全員を強制引き寄せ',
        tagline: '路上ライブで人々を引き寄せる、カリスマ流浪のアーティスト',
        passive: { name:'【投げ銭】', desc:'他のプレイヤーが自分と同じマスまたは隣接マスに止まる/通過するたびに、銀行から3Pを自動獲得。' },
        action: { name:'【路上ライブ】 (4AP)', desc:'周囲2マス以内の全プレイヤーを自分のマスに強制引き寄せ。ヤクザ横や元ヤンのカツアゲコンボなどに応用可。' },
    ...
    },
    {
        ...
        name: '闇医者',
        emoji: '🩺',
        infoDesc: '【自己治癒】ターン開始時HP+5 / 【闇診療】2AP:同マス相手HP+30→5P強制徴収',
        tagline: '闇の診療所を開く、危うい善意の医者',
        passive: { name:'【自己治癒】', desc:'毎ターン開始時に自動でHP5を回復。長期戦で確実に真価を発揮する持久型パッシブ。' },
        action: { name:'【闇診療】 (2AP)', desc:'同マスの相手のHPを30回復する代わりに5Pを強制徴収。助けるフリをしたカツアゲ。' },
    ...
    },
    {
        ...
        name: 'ギャンブラー',
        emoji: '🎲',
        infoDesc: '【アドレナリン】ゾロ目でAP倍+HP10回復＆25%で3ダイス / 【イカサマ勝負】2AP:1d6対決・勝者が5P奪取',
        tagline: '運命を賭けることに喜びを感じる、無一文の賭博師',
        passive: { name:'【アドレナリン】', desc:'ゾロ目が出た時、APが倍になるだけでなくHPも10回復。さらに毎ターン25%の確率で3つ目のサイコロが追加で振られる高リスク高リターン型。' },
        action: { name:'【イカサマ勝負】 (2AP)', desc:'同マスの相手と1〜6のサイコロ対決。勝者が負けた方から5Pを奪う。同点は仕掛けた側の負け。' },
    ...
    },
    {
        ...
        name: '元探偵',
        emoji: '🕵️',
        infoDesc: '【張り込み】自陣地侵入者の手札を30%で没収 / 【情報操作】3AP:好きなNPC1体を任意マスへ移動(CD:3R)',
        tagline: '陰からすべてを見通す、元・辣腕探偵',
        passive: { name:'【張り込み】', desc:'自分の陣地に他プレイヤーが完全に止まった時、30%の確率で相手の手札を1枚没収する。' },
        action: { name:'【情報操作】 (3AP)', desc:'マップ上の好きなNPC（警察・ヤクザ・収集車など）を1体選び、任意のマスへ瞬間移動させる。一度使うと3ラウンドのクールタイムが必要。' },
